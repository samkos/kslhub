...
from jhub_ssh_user_authenticator.authen import session_manager
...
class BatchSpawnerBase(Spawner):
    ...
    def submit_batch_script(self):
        ...
        f = open("/home/kortass/JUPYTER/last_script","w")
        f.write(script)
        f.close()
        ...
        os.system("env > /home/kortass/JUPYTER/last_script_env")
        ...
        f = open("/home/kortass/JUPYTER/last_script_modified","w")
        f.write(script)
        f.close()
