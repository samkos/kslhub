...
def start():
    ...
    if not(os.path.exists("jobs")):
      cmd = """
         mkdir -p jobs logs runtime ~/.jupyter/migrated ~/.local/share/jupyter ~/.jupyter/lab
         chmod 777 jobs logs runtime ~/.jupyter/migrated ~/.local/share/jupyter ~/.jupyter/lab
      """
      os.system(cmd)
